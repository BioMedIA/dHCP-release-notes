...
and radiology score. More specific information about the available data can
be found in the accompanying Release Notes . To access the data you will
be required to agree to a simple data sharing agreement and will then be
provided with access routes to two different modes of data download.
...
detailed in the How to cite notes.  
